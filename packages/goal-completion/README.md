...
ACP marker harvest + hidden continue nudges mount only on lumine ACP sessions (`claude-code`, `codex`, `cursor`, `grok-build`) and never beside `dsh-goal-round-driver`.
